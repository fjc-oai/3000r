...
build_frontend() {
  ...
  if [ ! -d node_modules ]; then
    notice "Installing frontend dependencies (node_modules not found)..."
...
ensure_venv() {
  ...
  notice "Installing backend requirements..."
...
deactivate_cmd() {
  # Works only if this script is sourced
...
Commands:
  ...
  serve        Ensure venv and run uvicorn (backend)
  start        build + serve
